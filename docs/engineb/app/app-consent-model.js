...
export var ConsentBlockKind;
(function (ConsentBlockKind) {
    ConsentBlockKind["modifying"] = "modifying";
    ConsentBlockKind["readOnlyRun"] = "read-only-run";
})(ConsentBlockKind || (ConsentBlockKind = {}));
...
export function groupConsentScriptsIntoBlocks(scripts) {
    const blocks = [];
...
export function checkConsentScriptOverflowsPreview(code) {
...
export function splitInlineInterpreterCode(code) {
...
export function formatConsentSourceToken(source) {
    if (source === undefined) {
        return "";
    }
...
export function findDefaultConsentSelectionIndex(scripts) {
...
export function clampConsentSelectionStep(currentIndex, delta, visibleRowCount) {
