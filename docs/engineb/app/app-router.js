...
import { ensureProgressTerminal, expandProgressConsole, progressTerminal } from "./app-console.js";
import { inflightLoadController } from "./app-fetch.js";
import { checkRouteIsTimeline, parseRouteSegments, routeToTimeline } from "./app-routes.js";
import { renderSubRouteDrawer, resetDetailsPane } from "./app-drawer.js";
import { maybeOfferProjectPathsWizard } from "./app-paths-project.js";
...
export function resetLastLoadedProject() {
...
function checkRouteRenderIsStale(generation) {
...
async function renderProjectRoute(view, segments, generation) {
    ...
    if (checkRouteRenderIsStale(generation))
        return;
...
export async function renderRoute() {
    ...
    document.getElementById("toggle-all").hidden = false;
    ...
    try {
        ...
        if (error instanceof DOMException && error.name === "AbortError")
            return; // cancelled — console already logged it
...
function setToolbarTitle(project) {
