...
export function applyRenameBadgeLabels(entries) {
    const badges = [];
...
function computeBadgeLabel(badge) {
...
function deepenCollidingBadges(badges) {
...
function findGrowableBadges(group) {
...
export function findScriptRenameSource(document, target) {
...
// be cwd-relative.
function checkRenamePairNamesTarget(pair, target) {
    if (pair.to === target) {
        return true;
    }
