...
import { COMMIT_NODE_KIND, COMMIT_OPERATION_KIND, TOOL_CALL_NODE_KIND, } from "./timeline-types.js";
...
export function deriveCommitNodes(document) {
...
export function deriveToolCallNodes(document) {
    const failedGitCommandUuids = new Set((document.gitOperations ?? [])
    ...
    const scriptRunsByToolUseId = new Map((document.scriptRuns ?? [])
