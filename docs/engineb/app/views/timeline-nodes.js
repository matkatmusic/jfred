...
import { recordGitBaselineSnapshot } from "./timeline-baseline-host.js";
import { checkSnapshotIsGitBaseline, deriveNodeFileChanges, indexRevisionsByChangeId, } from "./timeline-changes.js";
import { LINE_NODE_KIND, deriveLineNodes } from "./timeline-line-nodes.js";
import { deriveCommitNodes, deriveToolCallNodes } from "./timeline-node-derive.js";
import { AGENT_TURN_NODE_KIND, COMMIT_NODE_KIND, SESSION_END_NODE_KIND, TOOL_CALL_NODE_KIND, USER_ROLE, USER_TURN_NODE_KIND, } from "./timeline-types.js";
...
function attachSnapshotsToAgentTurns(turnNodes, commitNodes, steps) {
...
function appendSessionEndNodes(turnNodes, toolCallNodes) {
    const lastTurnTimes = new Map();
    const noteSessionInstant = (sessionId, when) => {
...
function filterPreBaselineNodes(nodes, preBaselineSkipped) {
...
// is ever dropped.
export function buildTurnTimelineViewModel(document, includeAllLines = false) {
