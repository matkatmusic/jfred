...
import { checkNodeIsPickable, checkPickIsLegal, computeRangeSummary } from "./timeline-picks.js";
export function buildConsentParams(context) {
...
export async function fetchRangePatch(context, fromStep, toStep) {
...
function clearAllPickBoxes(context) {
...
export function renderSelectbarButtons(context) {
...
function handlePickChange(context, pick) {
...
export function buildPickCell(context, node, index) {
