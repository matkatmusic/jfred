...
import { computeDetailsHeaderText, fullContentsIsOn } from "./details-model.js";
import { appendColumnsDiff, clearRightPaneBody, fetchRevisionDiffBlocks, hideDiffModeToggle, setDetailsHeader, setRightPaneLabel, } from "./details-diff.js";
import { buildScriptRunDetailsViewModel } from "./details-script-run-model.js";
export async function renderDetailsScriptRunMode(node, nodeIndex, context) {
    ...
    const showSelectedFileDiff = async (index) => {
...
function computeFileButtonLabel(entry) {
...
async function appendChangedFileDiff(body, entry, context) {
