...
import { fetchDocument, fetchJson, peekCachedDocument, } from "../app-fetch.js";
import { renderConsentDialog } from "../app-consent.js";
import { renderBaselineQuestionDialog } from "../app-baseline-question.js";
import { routeToFileHistory, routeToProject, routeToTimeline } from "../app-routes.js";
...
function appendTouchedFileLink(drawer, project, target, activeTarget) {
    drawer.append(el("a", {
