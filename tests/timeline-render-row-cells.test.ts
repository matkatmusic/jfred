// Role-class tests for webapp/views/timeline-render-row-cells.ts (task 160): raw-line rows
// get their own text color class instead of falling through to the session-end styling.
