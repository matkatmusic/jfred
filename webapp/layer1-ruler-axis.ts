...
// `measureContentFloorPx` is asked about each gap's earlier instant: rows hang below it, so the leaving gap pays.
...
export function layOutNodeLadders(ladders: NodeLadder[], onLadderPlaced?: LadderPlacedCallback): RulerLayout {
