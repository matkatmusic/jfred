...
// One source entry on the wire (WireSourceEntry server-side) — the client-side copy, precedent:
// app-paths-project.ts declares its own WireProjectPathsEntry client copy.
