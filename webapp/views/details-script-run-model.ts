...
// One changed file resolved for the right pane: target/revisionNumber are undefined when no
// reconstructed history tracks the path (the pane renders a note instead of a diff).
