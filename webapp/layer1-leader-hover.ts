...
// make the dashed leader line's color change to the same highlight color used for nodes and
// bubbles." Its own module rather than more of layer1-page.ts, which is at 220 of the repo's
// 250-line cap, and this is a second behaviour rather than a variation on the ruler-tick click.
...
// is tasks 283/267's single persistent selection, and this is a transient set of several elements.
